...
<div class="max-w-7xl mx-auto py-12 px-6">
    ...
    {{-- Acciones --}}
    <div class="mt-10 bg-zinc-900 border border-zinc-800 rounded-2xl p-6">
        ...
        <div class="flex flex-wrap gap-4">
            ...
            <a href="{{ url('/admin/users') }}"
               class="bg-white text-black px-5 py-3 rounded-xl font-medium hover:opacity-90 transition">
                Gestionar usuarios
            </a>

            <a href="#"
               class="bg-zinc-800 text-white px-5 py-3 rounded-xl font-medium hover:bg-zinc-700 transition">
                Gestionar juegos
            </a>
